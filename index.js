...
client.on('ready', () => {
  ...
  client.user.setActivity(`NKcodes`, {type:"PLAYING"});
...
if(interaction.commandName === "code"){ 
   if(!interaction.member.roles.cache.has("ايدي رول هنا"))  return interaction.reply({content: "This Command Only For Admin", ephemeral:true}) 
const ch = client.channels.cache.get("")// ايدي الروم هنا
